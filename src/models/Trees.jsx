...
Source: https://sketchfab.com/3d-models/oak-trees-d841c3bcc5324daebee50f45619e05fc
Title: oak trees
*/
...
import treeScene from "../assets/oak_trees.glb";

export function Oaktree({isRotating, setIsRotating, setCurrentStage, ...props}) {
  ...
  const handlePointerMove = (e) => {
    ...
    if(isRotating){
      ...
      treeRef.current.rotation.y += change * 0.01 * Math.PI
      lastX.current = clientX
      rotationSpeed.current = change * 0.01 * Math.PI
    }
  }
    ...
    <group ref={treeRef} {...props}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={(0.05, 0.05, 0.05)}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <group
            position={[-234.425, 1.687, 272.216]}
            rotation={[0, -1.171, 0]}
          >
            <mesh
              castShadow
